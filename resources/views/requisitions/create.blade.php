                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('purpose') is-invalid @enderror" 
                                  id="purpose" name="purpose" rows="3" required placeholder="Describe the purpose of this requisition">{{ old('purpose') }}</textarea>
                        @error('purpose')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ol class="pl-3">
                        ...
                        <li>Optionally select sub-department and division</li>
                        <li>Describe the purpose of the requisition</li>
                        <li>Add items you need</li>
                        <li>Submit for approval</li>
                    </ol>
                    <div class="alert alert-info mt-3">
                        <i class="icon fas fa-info"></i>
                        Your requisition will be reviewed by an administrator.
                    </div>
                </div>
            </div>
        </div>
...
function addItemRow() {
        ...
        <div class="card item-row" data-index="${itemIndex}">
            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="text-right">
                                <span class="badge badge-info item-unit-badge"></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="items[${itemIndex}][specifications]" rows="2" placeholder="Any specific requirements or specifications"></textarea>
                </div>
            </div>
        </div>
    `;
    ...
    $(`.item-row[data-index="${itemIndex}"] .item-select`).change(function() {
    ...
    $(`.item-row[data-index="${itemIndex}"] .item-quantity`).on('input', function() {
        const row = $(this).closest('.item-row');
        calculateItemTotal(row);
    });

    // Remove item event
    $(`.item-row[data-index="${itemIndex}"] .remove-item`).click(function() {
