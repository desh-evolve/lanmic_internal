    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @if(Auth::user()->hasAnyPermission(['view-requisitions', 'create-requisitions']))
                <li class="nav-item has-treeview {{ request()->is('requisitions*') && !request()->is('admin/requisitions*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        @if(Auth::user()->hasPermission('view-requisitions'))
                        <li class="nav-item">
                        ...
                        @endif
                        @if(Auth::user()->hasPermission('create-requisitions'))
                        <li class="nav-item">
                ...
                <!-- RETURNS Dropdown -->
                @if(Auth::user()->hasAnyPermission(['view-returns', 'create-returns']))
                <li class="nav-item has-treeview {{ request()->is('returns*') && !request()->is('admin/returns*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        @if(Auth::user()->hasPermission('view-returns'))
                        <li class="nav-item">
                        ...
                        @endif
                        @if(Auth::user()->hasPermission('create-returns'))
                        <li class="nav-item">
                ...
                @if(Auth::user()->hasAnyPermission(['approve-requisitions', 'issue-requisitions', 'approve-returns', 'view-purchase-orders', 'view-reports', 'view-users', 'view-roles', 'view-permissions', 'view-departments', 'view-sub-departments', 'view-divisions']))

                <li class="nav-header">ADMINISTRATION</li>

                <!-- Requisition Approvals -->
                @if(Auth::user()->hasAnyPermission(['approve-requisitions', 'issue-requisitions']))
                <li class="nav-item">
                ...
                <!-- Return Approvals -->
                @if(Auth::user()->hasPermission('approve-returns'))
                <li class="nav-item">
                ...
                @if(Auth::user()->hasPermission('view-purchase-orders'))
                ...
                @if(Auth::user()->hasAnyPermission(['view-users', 'view-roles', 'view-permissions', 'view-departments', 'view-sub-departments', 'view-divisions']))
                ...
                @if(Auth::user()->hasAnyPermission(['view-departments', 'view-sub-departments', 'view-divisions']))
                <li class="nav-item has-treeview {{ request()->is('admin/departments*') || request()->is('admin/sub-departments*') || request()->is('admin/divisions*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endif
                        @if(Auth::user()->hasPermission('view-sub-departments'))
                        <li class="nav-item">
