...
<div class="container-fluid">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('reports.local-issued-items') }}">
                <div class="row g-2">
                    ...
                    <input type="hidden" name="category" value="LOCAL">
                        ...
                        @empty
                            <tr>
                                <td colspan="14" class="text-center py-4">
                                    ...
                                    <p class="text-muted">No local items found for the selected filters.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="card mt-4">
        <div class="card-header" style="background-color: #2e7d32; color: white;">
            <h5 class="mb-0"><i class="fas fa-building mr-2"></i>Department-wise Local Item Issued Value</h5>
        </div>
