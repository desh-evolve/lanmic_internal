{{-- resources/views/admin/reports/import-issued-items.blade.php --}}
@extends('layouts.admin')

@section('title', 'Import Item Issuing Report')
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-0"><i class="fas fa-plane-arrival text-primary mr-2"></i>Import Item Issuing Report</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('reports.index') }}">Reports</a></li>
                            <li class="breadcrumb-item active">Import Item Issuing</li>
                        </ol>
                    </nav>
                </div>
                <div>
    ...
    <div class="card mb-4 no-print">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('reports.import-issued-items') }}">
                <div class="row g-2">
                    <div class="col-md-2">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">
                <i class="fas fa-table"></i> Import Item Issued Details
                <span class="badge badge-primary ml-2">Category: {{ request('category', 'IMPORT') }}</span>
            </h5>
        </div>
        <div class="card-body">
